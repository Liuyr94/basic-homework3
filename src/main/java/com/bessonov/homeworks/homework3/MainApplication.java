...
public class MainApplication {
    public static void main(String[] args) {
        ...
        System.out.println("Сумма элементов второй строки массива если она там есть равняется =  " + sumElementsSecondRow(arr));
    }

    /**
     * Метод для заполнения двухмерного массива случайными числами от 100 до 999
     *
     * @param array
     * @return
     */
    ...
    /**
     * Подсчитывает и возвращает сумму всех элементов двухмерного массива которые больше ноля.
     *
     * @param array
     */
